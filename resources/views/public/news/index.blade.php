<x-frontend-layout>
    ...
    <section class="py-24 bg-gray-50">
        <div class="section-container">
            ...
            @else
                <div class="text-center py-40 glass-card bg-white border-dashed border-2 border-gray-200">
                    ...
                    <p class="text-gray-500 max-w-sm mx-auto">Kami sedang mempersiapkan informasi menarik untuk Anda.
