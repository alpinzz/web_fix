                ...
                <section>
                    ...
                    <div class="mt-6">
                        <form action="{{ route('admin.galleries.store') }}" method="POST" enctype="multipart/form-data"
                            id="upload-form">
                            @csrf
                            <input type="file" class="filepond" Name="images[]" multiple data-max-file-size="2MB"
                                data-max-files="10" accept="image/png, image/jpeg, image/jpg" />
                            ...
                            <div class="relative group bg-gray-100 rounded-lg overflow-hidden border border-gray-200">
                                ...
                                <div
                                    ...
                                    <form action="{{ route('admin.galleries.destroy', $gallery->id) }}" method="POST"
                                        id="delete-gallery-form-{{ $gallery->id }}">
                                        @csrf
                                        @method('DELETE')
                                        <button type="button"
                                            onclick="confirmDelete('delete-gallery-form-{{ $gallery->id }}')"
